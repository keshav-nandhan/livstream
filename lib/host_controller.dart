...
import 'package:livstream/message.dart';
...
String appId="";
  ...
  Future<void> startStream() async {
    ...
    if (state.activeUsers.isEmpty) {
      ...
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(0).uid));
    } else if (state.activeUsers.length == 2) {
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(0).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(1).uid));
    } else if (state.activeUsers.length == 3) {
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(0).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(1).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(2).uid));
    } else if (state.activeUsers.length == 4) {
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(0).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(1).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(2).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(3).uid));
    } else if (state.activeUsers.length == 5) {
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(0).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(1).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(2).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(3).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(4).uid));
      ...
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(3).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(4).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(5).uid));
      ...
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(4).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(5).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(6).uid));
      ...
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(5).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(6).uid));
      transcodingUsers.add(TranscodingUser(state.activeUsers.elementAt(7).uid));
    } else {

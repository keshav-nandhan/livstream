...
import 'package:livstream/host_controller.dart';
...
//   Widget Build(BuildContext context){
//   return Widget Consumer(context,T Function<T>(ProviderBase<Object?>) watch) {
//     // return Consumer(builder:(context,T Function<T>(ProviderBase<Object?>) watch, Widget? child) {
        ...
        children: [
          ClipRRect(
            ...
            child: directorData.activeUsers.elementAt(index).videoDisabled
                ...
                : Stack(children: [
                    RtcRemoteView.SurfaceView(uid: directorData.activeUsers.elementAt(index).uid,channelId:""),
                    Align(
                      child: Container(
          ...
          ClipRRect(
            ...
            child: directorData.lobbyUsers.elementAt(index).videoDisabled
                ...
                : RtcRemoteView.SurfaceView(
                    uid: directorData.lobbyUsers.elementAt(index).uid,channelId: ""
                  ),
          ),
          Container(
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), color: Colors.black54),
